    ...
    <el-row align="middle">
      <el-col :span="6" :offset="9">
        <el-card shadow="always" class="loginCard">
          <div class="loginTitle">登录民宿预定平台</div>
          <div class="logo">
          ...
          >
            ...
            <el-form-item prop="roles">
              <el-radio v-model="userInfo.roles" label="admin" name="admin"  >管理员</el-radio>
              <el-radio v-model="userInfo.roles" label="user" name="user" >普通用户</el-radio>
            </el-form-item>
            <el-form-item>
              <el-button
                type="primary"
          ...
          <div class="registerBtn">
            <el-button type="text" @click="resetPassword" style="color: gray">忘记密码</el-button>
        ...
        if(list.length === 0){
          ...
          login(this.userInfo)
            .then(res => {
              ...
              that.$store.commit('setUserRole',res.data.userrole)
              setTimeout(() => {
                this.$notify({
                  title: '登录成功',
                  showClose:false,
                  ...
                  onClose:() => {
                    ...
                    setTimeout(() => {
                      ...
                      if (that.$route.query.redirect) { //如果存在参数
                        ...
                        that.$router.replace('/home')//则跳转至进入登录页前的路由
                      } else {
