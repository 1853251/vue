<template>
  <el-container>
    ...
    <el-table-column
      ...
      <template #header>
      <div>
        <el-button type="text" size="mini" icon="el-icon-s-operation"  @click="output">筛选</el-button>
        <!-- Form -->
      ...
      <el-dialog title="筛选条件" v-model="dialogFormVisible">
        ...
        <!--客容量-->
          <el-form-item label="客容量" :label-width="formLabelWidth">
            <el-input-number v-model="num" @change="handleChange" :min="1"  label="人数"></el-input-number>
          </el-form-item >
          <!--日期-->
